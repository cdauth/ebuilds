...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdelibs/kdelibs-4.1.3-r1.ebuild,v 1.1 2008/11/11 19:11:55 tgurr Exp $
...
PATCHES=( "${FILESDIR}/${PN}-4.1.1-cmake-modules.patch" "${FILESDIR}/${PV}-cmake-config.patch"  "${FILESDIR}/${PN}-4.1.3-privat.patch" )
